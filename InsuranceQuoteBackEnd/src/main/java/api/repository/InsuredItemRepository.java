...
public interface InsuredItemRepository extends JpaRepository<InsuredItem, Long> {
        ...
        // Custom Queries Using the equal operator to find objects
        ...
        List<InsuredItem> findByProductTypeAndProductValue(String productType, double productValue);

        // Using the or operator to find objects using the equal operator
        List<InsuredItem> findByProductTypeOrProductValue(String productType, double productValue);

        // Using the between operator to find objects
        List<InsuredItem> findByProductValueBetween(double startValue, double endValue);
