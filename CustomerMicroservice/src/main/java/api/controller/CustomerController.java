...
public class CustomerController {
    ...
    /***************************************************************
     * findAllCustomer()
     * Handles GET requests to retrieve all customer
    ...
    /***************************************************************
     * addCustomer()
     * Handles POST requests to add new customer .
     * Accepts a Customer object in the request body and
     * returns the created Customer object with a CREATED
     * status.
     ***************************************************************/
    // http://localhost:9999/api/customer
    @PostMapping
    ...
    /***************************************************************
     * updateCustomer()
     * Handles PUT requests to update existing customer .
     * Accepts an account number as a path variable and a
     * Customer object in the request body. Returns the
    ...
    /***************************************************************
     * deleteCustomer()
     * Handles DELETE requests to remove customer by
     * account number. Accepts an account number as a path
     * variable and returns a confirmation message with an OK
     * status.
     ***************************************************************/
     ...
     * Handles GET requests to retrieve customer by
     * account number. Accepts an account number as a path
     * variable and returns the corresponding Customer
     * object with an OK status. If not found, returns a NOT
     * FOUND status.
     ***************************************************************/
    // Example endpoint to get customer by account number
    ...
    /****************************************************************
     * findCustomerById()
     * Handles GET requests to retrieve customer by ID.
     * Accepts an ID as a path variable and returns the
     * corresponding Customer object with an OK status. If
    ...
    /***************************************************************
     * countCustomers()
     * Handles GET requests to count the total number of
     * customers. Returns the count as a string message with an
     * OK status.
     ***************************************************************/
     ...
     *                    Returns a list of product descriptions for the specified
     *                    type
     ***************************************************************/
